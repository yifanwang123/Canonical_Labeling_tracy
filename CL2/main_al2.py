...
#         # if i == 0:
#         #     print(f'leaf {i} ==========================================')
#         #     print(node.invariant[0])
#         #     print(node.invariant[17])
#         #     print(node.invariant[30])
...
def compute_canonical_form(graph, leaves):
    ...
    for leave in leaves:
        ...
        sequences.append(leave.invariant)

    # Compute invariants for all sequences
    invariants = [(seq, idx) for idx, seq in enumerate(sequences)]
...
def draw_two_graphs(graph1, graph2, labels1=None, labels2=None, title1="Graph 1", title2="Graph 2"):
    ...
    nx.draw(graph1, pos1, with_labels=True, labels={node: node for node in graph1.nodes()}, 
            ...
            edge_color='gray', arrowsize=5, ax=ax1)  # Smaller arrowsize and smaller node size
    if labels1:
    ...
    plt.savefig('/home/cds/Documents/canonical_labeling/1.pdf', format='pdf')
...
dataset = 'benchmark1'
directory = '/home/cds/Documents/canonical_labeling/data/benchmark1/cfi-rigid-t2_2'
